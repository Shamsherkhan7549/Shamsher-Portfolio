...
const Home = () => {
  ...
  return (
    <div className='flex justify-between items-center pl-25 pr-50 py-15'>
      <div className=' leading-17'>
        <h1 className='text-5xl font-bold  leading-17 text-blue-950'>
          Hi There , <br />
        ...
        <div className='flex gap-5 items-center'>
          ...
          <p className='bg-blue-950 text-cyan-300 hover:bg-cyan-300 hover:text-white cursor-pointer h-[50px] w-[50px] rounded-full flex items-center justify-center'> <Link to={"https://www.canva.com/design/DAGswlrfFlU/OENKA-ZYn0pSRwA6r9hSBQ/edit"}> <EditDocumentIcon/> </Link> </p>
        </div>
      ...
      <div className='container w-100'>
        <main className='flex justify-center align-center flex-1'>
          <AnimatePresence mode="wait">
            ...
            >
              <img className='rounded-full' src="/portfolio.png" alt="shamsher_img" />
